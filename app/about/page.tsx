...
const partners = ["Futuro Florestal", "Rabobank", "Florestas Engenharia", "Implantar"];
...
const timeline = [
  ...
  { year: "2023", event: <>Built TerraHub, our proprietary development and MRV platform.</> },
  {
    ...
    event: (
      <>
        Sapucaia certified to VCS and CCB, with a Sylvera rating. <Tbc>confirm certification year (2024 or 2025)</Tbc>
      </>
    ),
  },
  {
    ...
    event: (
      <>
        Trees for Farmers developed in partnership with Rabobank. <Tbc>confirm year</Tbc>
      </>
    ),
  },
];
...
const resources = [
  ...
  { icon: MapPin, tag: "Project brief", title: "Sapucaia project brief", desc: "A deep-dive into our flagship certified reforestation project in Bahia." },
];
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <div id="story" className="scroll-mt-32">
          ...
          <section className="py-24 bg-forest-muted">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <h2 className="text-3xl font-extrabold text-navy mb-12 max-w-xl">Values that guide every project we develop.</h2>
          ...
          <section className="py-24 bg-muted">
            <div className="max-w-4xl mx-auto px-6">
              <div className="text-xs font-semibold text-forest uppercase tracking-widest mb-3">Milestones</div>
              ...
              <div className="space-y-0">
                {timeline.map((t, i) => (
                  <div key={t.year} className="flex gap-8 items-start group">
                    <div className="text-right shrink-0 w-14"><span className="text-sm font-bold text-forest">{t.year}</span></div>
                    ...
                    <div className="pb-8"><p className="text-sm text-ink-soft leading-relaxed">{t.event}</p></div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <h2 className="text-3xl font-extrabold text-navy mb-4 max-w-xl">We build with trusted partners.</h2>
              ...
              <div className="flex flex-wrap items-center gap-4">
                {partners.map((p) => (
                  <div key={p} className="rounded-xl border border-border bg-white px-6 py-4 text-sm font-bold text-ink">{p}</div>
                ))}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {team.map((t) => (
                <div key={t.name} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/8 transition-colors">
                  ...
                  <div className="font-bold text-white mb-0.5">{t.name}{t.credential ? `, ${t.credential}` : ""}</div>
        ...
        <section id="resources" className="scroll-mt-32 py-24 bg-muted">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-xs font-semibold text-forest uppercase tracking-widest mb-3">Resources</div>
            <h2 className="text-3xl font-extrabold text-navy mb-4 max-w-xl">Information decks and guides.</h2>
            <p className="text-ink-soft mb-12 max-w-2xl leading-relaxed">
              We produce information decks to help clients, partners, and investors get up to speed quickly. Request any of the below and we will share it with you.
            </p>
                ...
                <div key={r.title} className="flex flex-col rounded-2xl border border-border bg-white p-6 hover:border-forest/30 transition-colors">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-11 h-11 rounded-xl bg-forest-muted flex items-center justify-center">
                      <r.icon className="w-5 h-5 text-forest" />
                    </div>
                  ...
                  <Link href="/contact" className="inline-flex items-center gap-1.5 text-sm font-semibold text-forest hover:text-forest-dark transition-colors">
                    Request the deck <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
              ))}
            </div>
            <p className="mt-8 text-xs text-ink/50">
              <Tbc>upload final deck files and wire direct or gated (email-capture) downloads; confirm which resources are public</Tbc>
            </p>
          </div>
        </section>
