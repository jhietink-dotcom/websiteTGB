...
export const projectsStatic: ProjectStatic[] = [
  ...
  { num: "04", flag: "🇧🇷", photo: "/img/biochar.jpg", align: "right", statusKey: "Development", kind: "biochar", lat: -1.72, lon: -48.88 }, // Abaetetuba, Pará
  { num: "05", flag: "🇹🇿", photo: "/img/DSCF9797.JPG", align: "left", statusKey: "Development", kind: "arr", lat: -5.3, lon: 36.98 }, // Kiteto, Tanzania
];
